export const SERVICES = [
  { id: '01', title: 'DATA ANALYSIS', description: 'Expert in Python (Pandas, NumPy) and SQL for extracting insights from complex datasets and performing statistical analysis.' },
  { id: '02', title: 'DATA VISUALIZATION', description: 'Creating impactful visual stories using Power BI, Tableau, and Matplotlib to make data accessible and actionable.' },
  { id: '03', title: 'MACHINE LEARNING', description: 'Building and deploying predictive models using Scikit-Learn, XGBoost, and TensorFlow to solve real-world business problems.' },
  { id: '04', title: 'DATA ENGINEERING', description: 'Designing efficient ETL pipelines and managing database architectures to ensure high-quality data flow.' }
];
...
export const FAQS = [
  ...
  { q: 'CAN YOU BUILD CUSTOM MACHINE LEARNING MODELS?', a: 'Yes, I specialize in building custom ML models tailored to specific business needs, from predictive analytics to deep learning architectures.' },
  { q: 'DO YOU HELP WITH DATA ENGINEERING AND ETL?', a: 'Absolutely. I design and implement robust ETL pipelines to ensure high-quality data flow and integrity for your analysis.' },
  { q: 'HOW DO YOU ENSURE DATA PRIVACY AND SECURITY?', a: 'I follow industry-standard best practices for data handling, ensuring all sensitive information is handled securely and ethically.' },
  { q: 'WHAT IS YOUR TYPICAL PROJECT TIMELINE?', a: 'Timelines vary based on complexity, but a standard data analysis project or ML model typically takes between 2 to 4 weeks.' },
  { q: 'HOW CAN WE GET STARTED ON A PROJECT?', a: 'You can reach out via the contact form below or connect with me on LinkedIn to discuss your data challenges.' }
];
...
export const SKILLS = [
  ...
  { name: 'Power BI/Tableau', level: 90, category: 'Visualization' },
  { name: 'Docker/MLOps', level: 75, category: 'Engineering' },
  { name: 'Hugging Face', level: 85, category: 'AI' }
];
